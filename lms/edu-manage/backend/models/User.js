...
// Export based on MongoDB availability
if (!process.env.MONGODB_URI || process.env.MONGODB_URI === 'mock') {
  // Use mock implementation - don't create Mongoose model
  module.exports = require('./MockModels').User;
} else {
  // Only create Mongoose model if MongoDB is actually available
  try {
    module.exports = mongoose.model('User', userSchema);
  } catch (e) {
    // If Mongoose model already created, get it
